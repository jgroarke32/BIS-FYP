...
(function () {
    ...
    ko.simpleGrid = {
        ...
        viewModel: function (configuration) {
            ...
            this.pageSize = ko.observable(configuration.pageSize) || 25;
            this.currentpagesize = ko.observable(0);

            // If you don't specify columns configuration, we'll use scaffolding
            this.columns = configuration.columns || getColumnsForScaffolding(ko.utils.unwrapObservable(this.data)); 

            this.itemsOnCurrentPage = ko.computed(function () {
                console.log(this.pageSize()); console.log(this.currentPageIndex());
                var startIndex = this.pageSize() * this.currentPageIndex();
                //var number = this.data().length - startIndex;
                //if (number > this.pageSize()) {
                //    this.currentpagesize(this.pageSize());
                //}
                //else {this.currentpagesize(number);}
                console.log(this.pageSize()); console.log(this.currentPageIndex());
